...
const DICTIONARY = {
  ar: {
    ...
    // Voice / Fish Audio
    settings_section_voice: "الصوت",
    voice_saved: "تم حفظ إعدادات الصوت",
    voice_save_failed: "فشل حفظ إعدادات الصوت",
    voice_disabled: "تم تعطيل الصوت",
    voice_disabled_label: "معطّل",
    voice_default: "الصوت الافتراضي",
    voice_api_key: "مفتاح Fish Audio",
    voice_id: "معرّف الصوت",
    voice_browse_voices: "تصفح الأصوات المتاحة",
    voice_name: "اسم الصوت (اختياري)",
    voice_name_placeholder: "مثال: جارفيس",
    voice_speed: "السرعة",
    voice_model: "النموذج",
    voice_test: "تجربة",
    voice_test_text: "مرحباً سيدي، أنا جارفيس، في خدمتك.",
    voice_disable: "تعطيل",
    voice_save: "حفظ",
    voice_play: "تشغيل",
    voice_stop: "إيقاف",
  ...
  en: {
    ...
    voice_save_failed: "Failed to save voice settings",
    voice_disabled: "Voice disabled",
    voice_disabled_label: "Disabled",
    voice_default: "Default voice",
    voice_api_key: "Fish Audio API key",
    voice_id: "Voice ID",
    voice_browse_voices: "Browse available voices",
    voice_name: "Voice name (optional)",
    voice_name_placeholder: "e.g. Jarvis",
    voice_speed: "Speed",
    voice_model: "Model",
    voice_test: "Test",
    voice_test_text: "Hello sir, I am Jarvis, at your service.",
